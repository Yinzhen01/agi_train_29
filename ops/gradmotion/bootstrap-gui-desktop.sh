...
Default flow:
  ...
  3. check GPU / DISPLAY / Isaac Gym / torch / X1 task shape
...
main() {
  ...
  if [[ "${DO_TRAIN}" == "1" ]]; then
    ...
    log "To start training: RUN_NAME=x1_dh_stand_v1 bash ops/gradmotion/bootstrap-gui-desktop.sh --train"
  fi
}

...
Common examples:
  ...
  bash ops/gradmotion/deploy_x1_remote.sh --server user@1.2.3.4 --conda-env pointfoot_legged_gym --gpu 0
  bash ops/gradmotion/deploy_x1_remote.sh --server root@1.2.3.4 --skip-smoke
...
PY
  ...
  printf '  CUDA_VISIBLE_DEVICES=%s WANDB_MODE=%s %s humanoid/scripts/train.py --task=%s --headless --run_name=x1_dh_stand_v1\n' \
